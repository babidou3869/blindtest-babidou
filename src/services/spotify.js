...
const TOKEN_KEY = "babidou_spotify_token";
const VERIFIER_KEY = "babidou_code_verifier";
const STATE_KEY = "babidou_oauth_state";
...
export async function loginSpotify() {
  ...
  const codeChallenge =
    base64UrlEncode(hashedVerifier);
...
export async function exchangeCodeForToken(
  ...
  if (!codeVerifier) {
    throw new Error(
      "Code de sécurité Spotify introuvable."
    );
  }
  ...
  if (
    ...
    throw new Error(
      "La vérification de sécurité Spotify a échoué."
    );
  }
